# -*- coding: utf-8 -*-
#
# yunhuni server api documentation build configuration file, created by
...
#html_title = u'yunhuni server api v1.0'
...
htmlhelp_basename = 'yunhuniserverapidoc'
...
man_pages = [
    (master_doc, 'yunhuniserverapi', u'yunhuni server api Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'yunhuniserverapi', u'yunhuni server api Documentation',
     author, 'yunhuniserverapi', 'One line description of project.',
     'Miscellaneous'),
]
